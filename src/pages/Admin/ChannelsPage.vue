  ...
  <q-page>
    <div class="flex flex-center">
      ...
      <div v-if="tableRows.length" class="row full-width q-pa-lg">
        <q-table
          ref="qTableChannels"
          class="channels-table full-width"
...
export default defineComponent({
  ...
  setup() {
    const qTableChannels = ref(QTable);
    ...
    const getTitle = computed(() => {
      return `Channels (${tableRows.value.length})`;
    });

    const paginationOf = computed(() => {
      if (typeof qTableChannels.value.pagination !== "undefined") {
        const { computedRows, computedRowsNumber } = qTableChannels.value;
        const { page, rowsPerPage } = qTableChannels.value.pagination;
    ...
    return {
      ...
      onUpdateHeaderCheckBox(value, ev) {
        ...
        qTableChannels.value.computedRows.forEach(
